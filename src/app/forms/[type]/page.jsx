...
const BRAND_KEY = 'umbrella_group';
const BRAND = { name: 'Umbrella Group', bg: '#080604', accent: '#D4B87A', text: '#F5F0E8', font: "'Cormorant Garamond', serif" };
    ...
    <div style={{minHeight:'100vh',background:BRAND.bg,color:BRAND.text,fontFamily:BRAND.font}}>
      ...
      <div style={{position:'relative',zIndex:1,padding:'60px 20px 80px'}}>
        <div style={{maxWidth:560,margin:'0 auto'}}>
          ...
          <p style={{textAlign:'center',marginTop:40,fontSize:11,opacity:0.25,fontFamily:"'DM Sans',sans-serif",letterSpacing:1}}>© {new Date().getFullYear()} Umbrella Group — Powered by The Kollective</p>
        </div>
      </div>
    </div>
  );
